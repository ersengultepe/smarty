    ...
    <div class="row py-5 my-5">
        <div class="col-lg-4 appear-animation" data-appear-animation="fadeInRightShorter">
            <h2 class="font-weight-normal text-6 line-height-2 mb-4">
                <strong>
                    <mark>
                        {{ $bizKimiz->where("order", 1)->first()->getTranslatedAttribute('title', \Illuminate\Support\Facades\Session::get('locale')) }}
                    </mark>
                </strong>
            </h2>
            {{ $bizKimiz->where("order", 1)->first()->getTranslatedAttribute('text', \Illuminate\Support\Facades\Session::get('locale')) }}
            <br>
        ...
        <div class="col-lg-8 mt-5 mt-lg-0">
            <div class="row">
                ...
                @foreach($bizKimiz->where("order", ">", 1) as $item)
